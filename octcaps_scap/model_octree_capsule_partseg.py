...
class OctreeCaps_partseg(nn.Module):
    def __init__(self,args,output_channel =32,seg_num=50,latent_vec_size =32):
        ...
        self.bn0 = nn.BatchNorm1d(self.latent_vec_size)
        ...
        self.label_embedd = nn.Sequential(nn.Conv1d(16, 64, kernel_size=1, bias=False),
                                   self.bn1,
        ...
        self.conv2 = nn.Sequential(nn.Conv1d(1351, 1024, kernel_size=1, bias=False),
                                   self.bn2,
        ...
        self.conv6 = nn.Sequential(nn.Conv1d(128, seg_num, kernel_size=1, bias=False),
                                   self.bn6,
                                   nn.LeakyReLU(negative_slope=0.2),self.dp6)
    ...
    def forward(self,data,l):
        ...
        Latent = self.bn0 (self.Latentcaps(encoder))
        #print(f'latent = {Latent.shape}')  # batch ,40,40


        result = torch.bmm(encoder, Latent)
